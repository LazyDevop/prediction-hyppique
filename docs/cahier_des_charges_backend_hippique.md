...
- Le projet doit rester raisonnable dans sa fréquence d'appel (pas de
  ...
  personnel, pas d'aspirer l'intégralité des archives PMU en une nuit.
...
**Manque constaté** : aucun champ d'état du terrain (pénétromètrie) n'apparaît
...
- **Terrain absent de `performances-detaillees` — DÉCISION PRISE** : traité
  ...
  - *France Galop* (galop uniquement) publie officiellement l'indice de
    pénétromètrie et son qualificatif sur son site au moment de chaque
